...
pub fn all_skills() -> Vec<Box<dyn Skill>> {
    ...
    skills.extend(linalg::skills());
    skills.extend(quaternion::skills());
    skills.extend(ode::skills());
    skills.extend(geodesy::skills());
    skills.extend(atmospheric::skills());
    skills.extend(info_theory::skills());
    skills.extend(crypto_math::skills());
    skills.extend(rf_link::skills());
    skills.extend(radar::skills());
    skills.extend(dsp_advanced::skills());
    skills.extend(tracking::skills());
    skills.extend(acoustic::skills());
    skills.extend(nav_aiding::skills());
    skills.extend(trajectory::skills());
    skills.extend(earth_models::skills());
    skills.extend(optimization::skills());
    skills.extend(open_data::skills());
    skills.extend(chemistry::skills());
    skills.extend(biology::skills());
    skills.extend(bio_data::skills());
    skills.extend(nuclear::skills());
    skills.extend(radiology::skills());
    skills.extend(machinist::skills());
    skills.extend(cnc::skills());
    skills.extend(geo_convert::skills());
    skills.extend(interchange::skills());
    skills.extend(new_charts::skills());
